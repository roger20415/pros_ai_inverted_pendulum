...
from rl_package.callbacks.fps_monitor_callback import FpsMonitorCallback
...
class CallbackManager:
    ...
    def __init__(self) -> None:
        ...
        self.fps_monitor_callback = FpsMonitorCallback()

        self.callbacks: list[BaseCallback] = [self.save_model_callback, self.fps_monitor_callback]
